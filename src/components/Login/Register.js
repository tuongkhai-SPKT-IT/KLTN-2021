  ...
  const setUserName = () => {
    return (
      <View
        ...
        <Modal position="center" swipeToClose={false} ref={initRef}
          style={{ flexDirection: "column", paddingVertical: 15, width: "85%", height: "30%" }}
          ref={initRef}>
          <View style={{ width: "100%", paddingHorizontal: 15 }}>
            <Text style={{
              color: 'black', fontSize: 22, fontWeight: "800", paddingBottom: 10
            }}>Bạn có muốn dừng tạo tài khoản không?</Text>
            <Text style={{ color: 'black', fontSize: 22, fontWeight: "800" }}>
              Nếu dừng bây giờ, bạn sẽ mất toàn bộ thông tin đã điền
          </Text>
          </View>
          <View style={{ width: "100%", flexDirection: "row" }}>
            <TouchableOpacity onPress={() => initRef.current.close()}
              style={[styles.appButtonContainer, { flex: 1, width: 0, backgroundColor: "transparent" }]}>
              <Text style={{ fontSize: 15, fontWeight: "400", color: "black", textAlign: "center" }}>Tiếp tục tạo tài khoản</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => { setVisible({ ...visible, userName: false }); history.push("/"); }}
              style={[styles.appButtonContainer, { flex: 1, width: 0, backgroundColor: "transparent" }]}>
              <Text style={{ fontSize: 15, fontWeight: "400", color: "#1877F2", textAlign: "center" }}>Dừng tạo tài khoản</Text>
            </TouchableOpacity>
          </View>
        </Modal>
        ...
        <View
          style={{
            ...
            top: 0, borderBottomColor: "rgba(0,0,0,0.4)", borderBottomWidth: 1,
            paddingVertical: 5
          }}>
        ...
        <View style={{ width: '100%', flexDirection: 'row', marginTop: 15 }}>
          <TextInput ref={input1}
            ...
            ]} placeholder="Họ" autoCapitalize="none" placeholderTextColor="black"
            onChangeText={(val) => onChangeText('last_name', val)} value={formData.last_name}
          />
    ...
    return (
      <View
        ...
        <View style={{
          ...
          <TouchableOpacity onPress={() => setVisible({ ...visible, userName: true, dOb: false })}
            style={{ position: "absolute", paddingVertical: 6 }}>
            <Image source={backIcon} />
          </TouchableOpacity>
        </View>
        ...
        <DatePicker
          ...
          mode="date"
        />
        <Modal position="center" swipeToClose={false}
          style={{ flexDirection: "column", paddingVertical: 15, width: "85%", height: "18%" }} ref={initRef}>
          <View style={{ width: "100%", paddingHorizontal: 15 }}>
            <Text style={{
              color: 'black', fontSize: 20, fontWeight: "800", paddingBottom: 10, textAlign: "center"
            }}>Cảnh báo</Text>
          ...
          <View style={{ width: "100%", flexDirection: "row" }}>
            <TouchableOpacity onPress={() => initRef.current.close()}
              style={[styles.appButtonContainer, { flex: 1, width: 0, backgroundColor: "#1877F2", borderTopLeftRadius: 0, borderTopRightRadius: 0 }]}>
    ...
    return (
      <View style={{ width: "100%", height: "100%", position: "relative" }}>
        <View style={{
          ...
          <TouchableOpacity onPress={() => setVisible({ ...visible, sex: false, dOb: true })}
            style={{ position: "absolute", paddingVertical: 6 }}>
            <Image source={backIcon} />
          </TouchableOpacity>
        </View>
        ...
        <View
          ...
          <Text style={{ fontWeight: "bold", fontSize: 24, marginBottom: 70 }}>Giới tính của bạn là gì?</Text>
          <RadioForm
              ...
              radio_props.map((arr, i) => {
                return (
                  <RadioButton labelHorizontal={true} key={i}
                    style={{
                      width: "100%", position: "relative", borderBottomColor: "rgba(0,0,0,0.5)",
                      borderBottomWidth: 1, paddingVertical: 20
                    }}>
                    <RadioButtonLabel
                      obj={arr}
                      index={i}
                      ...
                      labelWrapStyle={{}}
                    />
                    <RadioButtonInput obj={arr} index={i} isSelected={isSelected === i}
                      onPress={() => { setIsSelected(i); }}
                      borderWidth={1} // tạo thêm phần chú thích cho các cái nút giới tính này /// Ghi chú ăn xong làm
                      buttonInnerColor={isSelected === i ? "#1877F2" : 'rgba(0,0,0,0.8)'} //chấm tròn trong
                      buttonOuterColor={isSelected === i ? "#1877F2" : 'rgba(0,0,0,0.5)'} // màu viền
                      buttonSize={10}
                      buttonOuterSize={20}
                      buttonStyle={{}}
                      buttonWrapStyle={{ position: "absolute", right: 0, bottom: 20 }}
                    />
                  </RadioButton>
                )
              })
          ...
          <TouchableOpacity onPress={() => {
            if (isSelected > -1) {
              ...
              Alert.alert("Bạn phải chọn giới tính (giới tính trên giấy khai sinh)")
            }
          }
    ...
    return (
      <View
        ...
        <View style={{
          ...
          <Text style={{ fontSize: 20, marginLeft: 30 }}>Số di động và Email</Text>
          <TouchableOpacity onPress={() => setVisible({ ...visible, emailAndPhone: false, sex: true })}
            style={{ position: "absolute", paddingVertical: 6 }}>
            <Image source={backIcon} />
          </TouchableOpacity>
        </View>
  ...
  const setPassword = () => {
    return (
      <View
        ...
        <View style={{ width: '100%', flexDirection: 'column', marginTop: 15, marginBottom: 50 }}>
          <TextInput
            style={[
              styles.input,
            ]}
  ...
  return <View style={styles.container}>
    ...
    {visible.done && (
      <View style={{ width: "100%", height: "100%", }}>
        <Text style={{ fontWeight: "bold", fontSize: 20, textAlign: "center", position: "absolute", top: 20 }}>
          Đây là thông tin tài khoản của bạn, bạn hãy kiểm tra lại lần cuối và xác thực đăng ký</Text>
        <View style={{ flexDirection: "row", marginTop: 150 }}>
          ...
          <View style={{ flex: 2 }}>
            <Text style={[styles.collumn, styles.collumn1]}>{formData.last_name.trimEnd()}</Text>
            <Text style={[styles.collumn, styles.collumn1]}>{formData.first_name}</Text>
            <Text style={[styles.collumn, styles.collumn1]}>{formData.sex ? "Nam" : "Nữ"}</Text>
            <Text style={[styles.collumn, styles.collumn1]}>{formData.dOb}</Text>
            <Text style={[styles.collumn, styles.collumn1]}>{formData.phone}</Text>
            <Text style={[styles.collumn, styles.collumn1]}>{showEmail(formData.email)}</Text>
          </View>
        </View>
