        ...
        <SafeAreaView style={styles.container}>
          ...
          >
            <Tab.Screen name="Home" options={{
              tabBarIcon: () => {
                return <MaterialCommunityIcons name="home" color="#1877F2" size={26} />
              }
              }} 
              component={AppBar}
            />
            ...
            <Tab.Screen name="Messengers" options={{
              tabBarIcon: () => {
                return <MaterialCommunityIcons name="facebook-messenger" color="#1877F2" size={26} />
              }
            }} component={Messengers} />
            <Tab.Screen name="Profile" options={{
              tabBarIcon: () => {
                return <Ionicons name="person-circle-outline" color="#1877F2" size={26} />
              }
            }} component={Profile} />
          </Tab.Navigator>
        </SafeAreaView>
